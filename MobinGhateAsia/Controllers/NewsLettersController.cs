...
namespace MobinGhateAsia.Controllers
{
    ...
    public class NewsLettersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Email,IsDelete,SubmitDate,DeleteDate")] NewsLetter newsLetter)
        {
            if (ModelState.IsValid)
            {
				newsLetter.IsDelete=false;
				newsLetter.SubmitDate= DateTime.Now; 
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Email,IsDelete,SubmitDate,DeleteDate")] NewsLetter newsLetter)
        {
            if (ModelState.IsValid)
            {
				newsLetter.IsDelete=false;
        ...
        {
            NewsLetter newsLetter = db.NewsLetters.Find(id);
			newsLetter.IsDelete=true;
			newsLetter.DeleteDate=DateTime.Now;
